...
<li><a href="ai_match.php"><i class="bi bi-cpu"></i> <span class="sidebar-text">AI Match</span></a></li>
    ...
    <div class="topbar">
      <div class="topbar-left">
        ...
        <div class="topbar-title">
          ...
          <small>Patna | Station: Patna Central</small>
        </div>
      </div>
    ...
    <section id="admin-overview" class="py-4">
      ...
      <div class="row g-4 mb-4">
        <div class="col-6 col-md-2">
          <div class="card-admin" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            <div class="small" style="color: rgba(255,255,255,0.9);">Total Users</div>
        ...
        <div class="col-6 col-md-2">
          <div class="card-admin" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
            <div class="small" style="color: rgba(255,255,255,0.9);">Police Accounts</div>
        ...
        <div class="col-6 col-md-2">
          <div class="card-admin" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
            <div class="small" style="color: rgba(255,255,255,0.9);">Total Reports</div>
            <div class="value">14,205</div>
            <small style="color: rgba(255,255,255,0.8);">
              <i class="bi bi-file-earmark-text"></i> Submitted
            </small>
          </div>
        </div>
        <div class="col-6 col-md-2">
          <div class="card-admin" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
            <div class="small" style="color: rgba(255,255,255,0.9);">Matches Found</div>
            <div class="value">1,024</div>
            <small style="color: rgba(255,255,255,0.8);">
              <i class="bi bi-check-circle"></i> AI / Manual
            </small>
          </div>
        </div>
        <div class="col-6 col-md-2">
          <div class="card-admin" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
            <div class="small" style="color: rgba(255,255,255,0.9);">Pending Verifications</div>
        ...
        <div class="col-md-8">
          <div class="viz-card">
            <div class="viz-card-header">
              <i class="bi bi-graph-up me-2"></i>Monthly Reports Trend
            </div>
            <div class="viz-card-body">
              ...
              <div class="mt-3">
                <div class="d-flex justify-content-between align-items-center">
                  <span class="text-muted">Total Reports This Year</span>
                  <span class="counter-animate" data-count="14205">0</span>
                </div>
                <div class="progress-3d mt-2">
                  <div class="progress-bar" style="width: 78%;"></div>
                </div>
                <small class="text-muted">78% compared to last year</small>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-4">
        <div class="col-12">
          <div class="viz-card">
            <div class="viz-card-header">
              <i class="bi bi-diagram-3 me-2"></i>System Network Overview
            </div>
            <div class="viz-card-body">
              <div id="networkGraph" class="chart-container" style="height: 320px;"></div>
              <div class="row mt-3">
                <div class="col-md-3">
                  <div class="stat-card-3d text-center">
                    <i class="bi bi-people-fill text-primary fs-4"></i>
                    <div class="counter-animate" data-count="8542">0</div>
                ...
                <div class="col-md-3">
                  <div class="stat-card-3d text-center">
                    ...
                    <div class="counter-animate" data-count="14205">0</div>
                ...
                <div class="col-md-3">
                  <div class="stat-card-3d text-center">
                    ...
                    <div class="counter-animate" data-count="42">0</div>
    ...
    <section id="manage-reports" class="py-4">
      ...
      <div class="table-responsive">
        <table class="table table-hover align-middle">
          <thead class="table-light">
<tr>
              <th><input type="checkbox" id="selectAllTargets" onclick="toggleAllTargets()"></th>
              <th>Report ID</th>
              <th>Missing Name</th>
              <th>Age/Gender</th>
  ...
  <script>
    // Dashboard2 notifications integration
