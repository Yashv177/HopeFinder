...
def camera_thread():
    ...
    while True:
        ...
        # location text
        location_text = f"{location_data['city']} {location_data['country']}"

        cv2.putText(frame,location_text,(10,60),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    0.6,(0,255,0),2)
...
def ai_thread():
    ...
    while True:
        ...
        for (x,y,w,h) in faces:
            ...
            if emb is not None and len(targets) > 0:
                ...
                if best_distance < MATCH_THRESHOLD:
                    ...
                    print("\nPERSON FOUND")
                    print("Name:",name)
                    print("Location:",location_data["city"],location_data["country"])
                    print("Saved:",save_name)

            detected_faces.append((x,y,w,h,name))

        latest_faces = detected_faces
